...
import { MultiplayerClient } from "./multiplayer-client.js?v=authoritative-relay-roster-v18";

const BUILD_ID = "authoritative-relay";
const ASSET_BUILD_ID = "authoritative-relay-roster-v18";
const CACHE_PREFIX = "tiberius-phone-";
const CURRENT_CACHE = "tiberius-phone-v84-pc-board-fit";
